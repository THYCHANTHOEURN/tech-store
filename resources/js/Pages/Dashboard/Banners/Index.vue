    ...
    <DashboardLayout>
        ...
        <v-container fluid class="py-8">
            ...
            <FilterBar :loading="loading" :total-items="banners.total" items-label="banners"
                ...
                <template #filters>
                    <v-col cols="12" md="4">
                        <SearchField v-model="search" :label="$t('Search Banners')" :loading="loading" @search="applyFilters"
                            @clear="applyFilters" />
                    </v-col>

                    <v-col cols="12" md="4">
                        <v-select v-model="selectedPosition" :items="positionOptions" :label="$t('Position')" hide-details
        ...
        <v-dialog v-model="deleteDialog" max-width="500px">
            <v-card>
                <v-card-title class="text-h5">{{ $t('Delete Banner') }}</v-card-title>
                <v-card-text>
                    {{ $t('Are you sure you want to delete this banner? This action cannot be undone.') }}
